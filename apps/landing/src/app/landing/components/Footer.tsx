...
export default function Footer() {
  ...
  const legalLinks = [
    ...
    { label: footer.termsAndConditions, href: "/terms-and-conditions" },
  ];

  const socialLinks = [
    {
      label: footer.twitter,
      href: "https://twitter.com/learnanything",
      icon: (
    ...
    {
      label: footer.github,
      href: "https://github.com/learnanything",
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path
            fillRule="evenodd"
    ...
    },
    {
      ...
      href: "https://discord.gg/learnanything",
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <footer className="bg-gray-950 text-gray-400">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          {/* Product links */}
          <div>
            <h3 className="text-sm font-semibold text-white">{footer.product}</h3>
          ...
          {/* Legal links */}
          <div>
            <h3 className="text-sm font-semibold text-white">{footer.legal}</h3>
            <ul className="mt-4 space-y-3">
              {legalLinks.map((link) => (
                <li key={link.href}>
                  <Link
          ...
          {/* Social links */}
          <div>
            <h3 className="text-sm font-semibold text-white">{footer.connect}</h3>
            <ul className="mt-4 space-y-3">
